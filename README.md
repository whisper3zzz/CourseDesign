...
这个仓库比较适合作为课程设计后续迭代的基础工程。可以继续扩展的方向包括：

- 增加更规范的数据集划分与实验评估
- 将 MindSpore CNN 训练与桌面端识别进一步打通
- 补充更多实验对比指标，如 `Accuracy / Precision / Recall`
- 接入更稳定的推理服务部署方式
- 继续优化界面交互和状态反馈

## 说明

当前 `README` 只保留项目结构、模块职责与工程框架说明，不再放具体部署实例、个人环境参数或课程过程文档。课程实验报告请单独维护，不纳入仓库公开内容。
